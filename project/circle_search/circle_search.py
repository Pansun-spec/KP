...
def hough_search(image):
    circles = cv2.HoughCircles(image, cv2.HOUGH_GRADIENT, 1, 100, 255, 255, 17,
                               0)  # dp, minDist, param1_Canny threshold, param2 center threshold, minr, maxr
...
if __name__ == "__main__":
    ...
    path = "/home/kehua/PycharmProjects/KP/project/circles_generate/diameter_true"
